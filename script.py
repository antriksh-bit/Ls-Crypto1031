...
# Function to compare the letter distribution of the given text with normal English
...
# Function to solve a Vigenere cipher by finding keys such that the plaintext resembles English
...
# Set of meaningful English words for verification
ENGLISH_WORDS = {
...
# Function to check if the given text contains a significant number of English words
...
# Main function to prompt for ciphertext and perform Vigenere decryption
def main():
